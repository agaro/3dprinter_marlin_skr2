...
#define STRING_CONFIG_H_AUTHOR "(agaro, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CE3Pro_BTTSKR2revB caqui"
...
#define Z_PROBE_LOW_POINT          -100 // Farthest distance below the trigger-point to go before stopping
